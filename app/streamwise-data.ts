...
export const options: Option[] = [
  ...
  },
  {
    ...
    covers: ["YouTube TV"],
    notes:
      "Limited-time new-user offer: $67.99/mo for first 3 months (save $45 total vs $82.99/mo), then $82.99/mo. Same 100+ channel main plan. Offer ends June 30, 2026; terms at tv.youtube.com/learn/offer-terms/.",
    source: "YouTube TV",
    sourceUrl: "https://tv.youtube.com/welcome/",
    category: "promo",
    mutuallyExclusiveGroup: "youtube_tv_access",
  ...
  },
  {
    ...
    covers: ["YouTube TV"],
    notes:
      "Limited-time new-user offer: $54.99/mo for first 12 months (save $120 total vs $64.99/mo), then $64.99/mo. Offer ends June 30, 2026; new users only. Terms at tv.youtube.com/learn/offer-terms/.",
    source: "YouTube TV",
    sourceUrl: "https://tv.youtube.com/welcome/",
    category: "promo",
    mutuallyExclusiveGroup: "youtube_tv_access",
  ...
  },
  {
    ...
    covers: ["Fubo"],
    notes:
      "Sports-first package (~25+ channels): ESPN, FS1/FS2, NFL Network, SEC/ACC/Big Ten networks, local ABC/CBS/FOX in select markets, and news. No regional sports network (RSN) fee on this tier per Fubo. 1,000 hours cloud DVR (9-month retention).",
    source: "Fubo",
  ...
  },
  {
    ...
    covers: ["Fubo"],
    notes:
      "Pro plan (~190–216+ channels), 1,000 hours cloud DVR, up to 10 streams at home. Includes major sports and entertainment; regional sports networks may apply with separate RSN fees in some markets. Price increased to $84.99/mo in early 2026.",
    source: "Fubo",
    sourceUrl: "https://www.fubo.tv/welcome/plans",
    category: "direct",
    mutuallyExclusiveGroup: "fubo_access",
  ...
  },
  {
    ...
    covers: ["Fubo"],
    notes:
      "Elite (~230–260+ channels): Pro lineup plus Fubo Extra, News Plus, and more sports nets (MLB Network, NBA TV, NHL Network, ESPNews, ESPNU, etc.). Same DVR and stream limits as Pro. RSN fees may apply.",
    source: "Fubo",
    sourceUrl: "https://www.fubo.tv/welcome/plans",
    category: "direct",
    mutuallyExclusiveGroup: "fubo_access",
  ...
  },
  {
    ...
    covers: ["Fubo"],
    notes:
      "Premier: Elite channels plus SHOWTIME included. For viewers who want premium entertainment and maximum sports channel breadth in one bill.",
    source: "Fubo",
    sourceUrl: "https://www.fubo.tv/welcome/plans",
    category: "direct",
    mutuallyExclusiveGroup: "fubo_access",
  ...
  },
  {
    ...
    covers: ["Fubo"],
    notes:
      "Spanish-language live TV package (~50–65+ channels): news, sports, and entertainment (e.g. Univision, Telemundo, TUDN). Can complement an English plan. Cloud DVR included.",
    source: "Fubo",
    sourceUrl: "https://www.fubo.tv/welcome/plans",
    category: "direct",
    mutuallyExclusiveGroup: "fubo_access",
  ...
  },
  {
    ...
    covers: ["Fubo"],
    notes:
      "Welcome offer: discounted first month on Sports + News, then $55.99/mo. Taxes, fees, and regional restrictions may apply. Confirm current promo on fubo.tv/welcome/plans at signup.",
    source: "Fubo",
    sourceUrl: "https://www.fubo.tv/welcome/plans",
    category: "promo",
    mutuallyExclusiveGroup: "fubo_access",
  ...
  },
  {
    ...
    provider: "direct",
    monthly: 48.99,
    standardMonthly: 84.99,
    introLengthMonths: 1,
    covers: ["Fubo"],
    notes:
      "Common new-subscriber intro on Fubo Pro (e.g. ~$48.99 first month, then $84.99/mo). Free trial may be offered instead—check checkout. RSN and other fees extra where applicable.",
    source: "Fubo",
    sourceUrl: "https://www.fubo.tv/welcome/plans",
    category: "promo",
    mutuallyExclusiveGroup: "fubo_access",
  ...
  },
  {
    ...
    covers: ["Philo"],
    notes:
      "Live TV: 70+ channels, 75,000+ on-demand titles, 1-year ad-skippable unlimited DVR, 3 simultaneous streams. 7-day free trial for new subscribers. Premium add-ons (Hallmark+ $8, ALLBLK $7, MGM+ $8, Movies & More $3, STARZ $12) billed separately.",
    source: "Philo",
  ...
  },
  {
    ...
    notes:
      "Everything in Essential plus HBO Max Basic with Ads, AMC+ (early access & library), and discovery+ (80,000+ on-demand titles). Advertised save ~$17/mo vs buying apps separately. No free trial on Bundle+ per philo.com pricing page.",
    source: "Philo",
    sourceUrl: "https://www.philo.com/go/pricing",
    category: "bundle",
