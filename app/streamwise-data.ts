...
export const options: Option[] = [
  // DIRECT STREAMING PLANS
  {
    ...
    covers: ["Netflix"],
    notes:
      "Ad-supported plan: most movies and TV shows, 2 simultaneous streams, 1080p Full HD, downloads on 2 devices. Live events included and may contain ads. US pricing from Netflix signup / help center.",
    source: "Netflix",
  ...
  },
  {
    ...
    covers: ["Hulu"],
    notes:
      "Standalone Hulu streaming with ads. Annual billing $119.99/yr (12 months for price of 10) also offered. Student plan $1.99/mo with verification. Signup via hulu.com/start or secure.hulu.com commerce.",
    source: "Hulu",
  ...
  },
  {
    ...
    notes:
      "Hulu (With Ads) + Live TV with 100+ channels, unlimited DVR, and streaming libraries: Disney+ (With Ads) and ESPN Select (access via ESPN app). 3-day free trial for eligible new/eligible returning subs. Stream on 2 devices (Unlimited Screens add-on +$9.99/mo).",
    source: "Hulu",
  ...
  // CORE BUNDLES
  {
    ...
    covers: ["Disney+", "Hulu"],
    notes:
      "Disney+ and Hulu (both with ads). Intro offer often $11.99/mo for first 6 months ($71.94 upfront), then $12.99/mo. Select Hulu titles stream on Disney+; full Hulu library remains in Hulu app.",
    source: "Disney / Hulu",
    sourceUrl: "https://help.hulu.com/article/hulu-how-much-does-hulu-cost",
    category: "bundle",
  ...
  },
  {
    ...
    covers: ["Disney+", "Hulu"],
    notes:
      "Ad-free Disney+ and Hulu on-demand. Intro often $17.99/mo for 6 months ($107.94), then $19.99/mo. Ads may still appear in select live/linear content per Disney terms.",
    source: "Disney / Hulu",
    sourceUrl: "https://help.hulu.com/article/hulu-how-much-does-hulu-cost",
    category: "bundle",
    mutuallyExclusiveGroup: "disney_hulu_family",
  ...
  },
  {
    ...
    notes:
      "Disney+, Hulu (with ads), and ESPN Select (ESPN+ content). Offer through Dec 31, 2026 per Hulu help pricing. Access each service separately.",
  ...
  },
  {
    ...
    covers: ["Disney+", "Hulu", "ESPN+"],
    notes:
      "Ad-free Disney+ and Hulu plus ESPN Select. Offer through Dec 31, 2026 per Hulu help pricing. Live/linear sports may still include ads.",
    source: "Disney / Hulu / ESPN",
    sourceUrl: "https://help.hulu.com/article/hulu-how-much-does-hulu-cost",
    category: "bundle",
    mutuallyExclusiveGroup: "disney_hulu_espn_family",
  ...
  },
  {
    ...
    covers: ["Disney+", "Hulu", "ESPN+"],
    notes:
      "$35.99/mo on plus.espn.com: Disney+, Hulu, and ESPN Unlimited (all ESPN networks + ESPN+). NFL, college football, NBA, NHL, originals, and Disney+/Hulu libraries. Also sold via Hulu signup. Switch or cancel at end of billing period per ESPN terms.",
    source: "ESPN / Hulu",
    sourceUrl: "https://help.hulu.com/article/hulu-how-much-does-hulu-cost",
    category: "bundle",
    mutuallyExclusiveGroup: "disney_hulu_espn_family",
  ...
  },
  {
    ...
    covers: ["Disney+", "Hulu", "ESPN+"],
    notes:
      "Disney+ and Hulu without ads on-demand plus ESPN Unlimited (all ESPN networks). ~33% off vs separate retail per Hulu help. Offer through Dec 31, 2026. Also listed on plus.espn.com.",
    source: "Disney / Hulu / ESPN",
    sourceUrl: "https://help.hulu.com/article/hulu-how-much-does-hulu-cost",
    category: "bundle",
    mutuallyExclusiveGroup: "disney_hulu_espn_family",
